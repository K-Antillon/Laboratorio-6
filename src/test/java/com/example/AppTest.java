...
public class AppTest 
{
    ...
    public static Object[][] proveedorDatos(){
        return new Object[][] {
            ...
            {"femenino", "24", "El valor de la prima anual de seguro de auto según su género y edad es: 1500 dólares"},
            {"femenino", "25", "El valor de la prima anual de seguro de auto según su género y edad es: 1500 dólares"},
            {"femenino", "64", "El valor de la prima anual de seguro de auto según su género y edad es: 1500 dólares"},
            {"masculino", "-1", "La edad no puede ser un valor negativo"},
            {"masculino", "0", "La edad del cotizante debe ser mayor o igual a 18 años"},
            {"femenino", "17", "La edad no puede ser un valor negativo"},
